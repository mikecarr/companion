...
public class GitHubPresetService : IGitHubPresetService
{
    ...
    /// Downloads any additional files referenced in the preset configuration
    /// </summary>
    private async Task DownloadAdditionalFilesAsync(string presetConfigYaml, string localPresetDir, GitHubFile githubFile)
    {
        try
        {
    ...
    private async Task DownloadAdditionalFileAsync(string fileName, string baseRepoUrl, string localPresetDir, string customUrl = null)
    {
        try
        {
